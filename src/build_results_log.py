...
R = [
 ...
 ["2026-08-01","Direction","Phase B ablation (+Tier-2)","HNB","daily","identical rows/split/seeds, A vs B","Logistic + XGBoost","direct, 9 horizons, ablation","Mean gain from Tier-2 (pp)",-1.1,0,"No","RSI+MACD+volume add NOTHING. Mean -1.1pp, positive at only 1/9 horizons, 0/9 beat baseline. Technical indicators exhausted.","results/direction/phase_ablation/ablation_summary.md","direction_phase_ablation.py; 9 -> 15 features"],
